...
export class FloaterEnemy {
    public static metadata = {
        name: 'Floater',
        faction: 'Green',
        description: 'Consumes other enemies to grow. Leaves a decaying toxic trail, regenerates rapidly upon eating, and violently explodes on player contact.'
    };
     ...
     * Instantly damages player based on total size mass and prunes the Floater from the active frame pool.
     */
